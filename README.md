...
| **Module**             | `module`, `import`, `global`, `data`, `func`, `export`, `start`                                 | `wasm.module()` should be followed by any number of `import()`, `global()`, `data()`, `func()`, `export()`, and `start()` calls to add the respective components to the module. To finalise the module, call `build()`.                                                                                                                                                                                                                                                                                                                                                                    |
